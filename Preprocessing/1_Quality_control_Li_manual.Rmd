...
Data originates from https://pubmed.ncbi.nlm.nih.gov/31067475/
...
sample_metadata <- read.table("~/Dropbox/Postdoc/2021-05-19_Gastric_IM/Additional_files/Samples_Li.txt", sep = "\t", header = TRUE, row.names = 1)
```



```{r data, eval=TRUE}
folders <- list.files("~/Dropbox/Postdoc/2021-05-19_Gastric_IM/Data_GSE134520/data/", full.names = TRUE)
folder.names <- list.files("~/Dropbox/Postdoc/2021-05-19_Gastric_IM/Data_GSE134520/data/", full.names = FALSE)
...
# Save list
saveRDS(sce.list, "~/Dropbox/Postdoc/2021-05-19_Gastric_IM/All_sce_unfiltered_Li_manual.rds")

saveRDS(sce.list.filtered, "~/Dropbox/Postdoc/2021-05-19_Gastric_IM/Final/All_sce_filtered_Li_manual.rds")
```
